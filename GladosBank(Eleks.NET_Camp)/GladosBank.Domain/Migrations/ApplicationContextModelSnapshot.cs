            ...
            modelBuilder.Entity("GladosBank.Domain.Account", b =>
                {
                    ...
                    b.HasOne("GladosBank.Domain.Customer", "_Customer_Id")
                        .WithMany()
                        .HasForeignKey("_Customer_IdId");

                    b.Navigation("_Currency");

                    b.Navigation("_Customer_Id");
                });
