        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    _Customer_IdId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Users__Customer_IdId",
                        column: x => x._Customer_IdId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts__Customer_IdId",
                table: "Accounts",
                column: "_Customer_IdId");
        }
